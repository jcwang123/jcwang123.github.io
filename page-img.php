...
<head>
    ...
    <noscript>
        <link rel="stylesheet" href="<?php usePublicCdn(); ?>/assets/css/noscript.css" />
    </noscript>
...
<body class="is-preload">
    ...
    <div id="wrapper">
        <!-- Header -->
        <header id="header">
            <h1><a href="<?php $this->options->siteUrl(); ?>"><strong><?php $this->options->title() ?></strong></a>の时光相册
            </h1>
            <nav>
                <ul>
                ...
                <div class="inner split">
                    <div>
                        ...
                        <section>
                            <h2>联系我</h2>
                            <ul class="icons">
                                <li><a href="<?php $this->options->siteUrl(); ?>" target="_blank"
                                        class="icon brands fa-telegram"><span class="label">HOOME</span></a></li>
                                <li><a href="<?php $this->fields->myqq()?>" target="_blank"
                                        class="icon brands fa-qq"><span class="label">QQ</span></a></li>
                                <li><a href="<?php $this->fields->myweibo()?>" target="_blank"
                                        class="icon brands fa-weibo"><span class="label">weibo</span></a></li>
                                <li><a href="<?php $this->fields->mygithub()?> " target="_blank"
